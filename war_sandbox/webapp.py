...
TEXT = {
    "zh": {
        ...
        "decision_panel_subtitle": "只围绕军事能力、战争成本、谈判信号三项主指标判断当前阶段和结束窗口。",
        ...
        "signal_stack": "固定信号栈",
        "signal_stack_subtitle": "信息源只服务于三项主指标：军事能力、战争成本、谈判信号。",
    ...
    "en": {
        ...
        "decision_panel_subtitle": "Built only on three core signals: military capability, war cost, and negotiation signals.",
        ...
        "signal_stack_subtitle": "Sources are organized only around three core signals: military capability, war cost, and negotiation signals.",
        ...
        "news_all": "All",
        "indicator_frame": "3 Core Signals",
